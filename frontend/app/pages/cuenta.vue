...
<template>
  <div v-if="authStore.user" class="max-w-4xl mx-auto px-4 py-10">
    <h1 class="text-2xl font-bold mb-8">Mi cuenta</h1>

    <div class="border border-zinc-200 dark:border-zinc-800 rounded-lg p-6 mb-10">
    ...
    <div v-else class="space-y-4">
      <div v-for="order in orders" :key="order.id" class="border border-zinc-200 dark:border-zinc-800 rounded-lg p-5">
